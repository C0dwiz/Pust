...
class TestMod(loader.Module):
        ...
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                (
                    ...
                    " Pust will try to determine, which client caused logs. E.g. there"
                    ...
                    " Pust will send all logs to Client1 and Client2, even if it is"
    ...
    async def client_ready(self):
        chat, _ = await utils.asset_channel(
            self._client,
            "Pust-logs",
            "🪐 Your Pust logs will appear in this chat",
            silent=True,
            invite_bot=True,
            avatar="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/Pust/Pust_logs.png",
        )
