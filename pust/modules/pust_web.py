...
@loader.tds
class PustWebMod(loader.Module):
    ...
    async def weburl(self, message: Message, force: bool = False):
        if "OTHERHOST" in os.environ or "JAMHOST" in os.environ:
            ...
            if (
                ...
                try:
                    if not await self.inline.form(
                        ...
                        photo="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/Pust/web_interface.png",
                    ):
                        raise Exception
                except Exception:
                    await utils.answer(
            ...
            if not main.Pust.web:
                main.Pust.web = core.Web(
                    data_root=main.BASE_DIR,
                    api_token=main.Pust.api_token,
                    proxy=main.Pust.proxy,
                    connection=main.Pust.conn,
                )
                await main.Pust.web.add_loader(self._client, self.allmodules, self._db)
                await main.Pust.web.start_if_ready(
                    len(self.allclients),
                    main.Pust.arguments.port,
                    proxy_pass=main.Pust.arguments.proxy_pass,
                )
            ...
            if force:
                ...
                await form.edit(
                    ...
                    photo=(
                        "https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/Pust/opening_tunnel.png"
                    ),
                )
            else:
                form = await self.inline.form(
            ...
            url = await main.Pust.web.get_url(proxy_pass=True)

            await form.edit(
                self.strings("tunnel_opened"),
                reply_markup={"text": self.strings("web_btn"), "url": url},
                photo="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/Pust/tunnel_opened.png",
            )
    ...
    def _get_client(self) -> CustomTelegramClient:
        return CustomTelegramClient(
            MemorySession(),
            main.Pust.api_token.ID,
            main.Pust.api_token.HASH,
            connection=main.Pust.conn,
            proxy=main.Pust.proxy,
