...
class InlineStuff(loader.Module):
    ...
    @loader.command()
    async def ch_Pust_bot(self, message: Message):
        ...
        self._db.set("Pust.inline", "custom_bot", args)
    ...
    async def aiogram_watcher(self, message: BotInlineMessage):
        ...
        if message.text == "/start":
            await message.answer_photo(
                ...
                caption=self.strings("this_is_Pust"),
            )
    ...
    async def reset_prefix(self, call: InlineCall, message):
        ...
        self.db.set("Pust.main", "command_prefix", ".")