...
# 🌐 https://github.com/hikariatama/Pust
...
class Web:
    ...
    async def custom_bot(self, request: web.Request) -> web.Response:
        ...
        db.set("Pust.inline", "custom_bot", text)
    ...
    async def web_auth(self, request: web.Request) -> web.Response:
        ...
        if not await main.Pust.wait_for_web_auth(token):
            for op in ops:
                await op()
