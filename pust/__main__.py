...
if (
    ...
    print("\U0001f6ab" * 15)
    print("You attempted to run Pust on behalf of root user")
...
if sys.version_info < (3, 12, 0):
    print("\U0001f6ab Error: you must use at least Python version 3.12.0")
elif __package__ != "pust":
    print(
    ...
    try:
        ...
        try:
            ...
            if tuple(map(int, telethon.__version__.split("."))) < (1, 1, 0):
                raise ImportError
        except ImportError:
    ...
    if "Pust_DO_NOT_RESTART" in os.environ:
        del os.environ["Pust_DO_NOT_RESTART"]
    if "Pust_DO_NOT_RESTART2" in os.environ:
        del os.environ["Pust_DO_NOT_RESTART2"]
