...
3. After payment confirmation, type `/install` and select Pust
...
| Type | Link |
|------|------|
| **User Documentation** | [Pust-ub.xyz](https://Pust-ub.xyz/) |
| **Developer Docs** | [dev.Pust-ub.xyz](https://dev.Pust-ub.xyz/) |

---

## 💬 Support

[![Telegram Support](https://img.shields.io/badge/Telegram-Support_Group-2594cb?logo=telegram)](https://t.me/Pust_talks)
...
- [**Lonami**](https://t.me/lonami) for Telethon (Pust-TL backbone)
